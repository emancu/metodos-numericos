...
Otra prueba que realizamos fue para fijar el parámetro de parada para \textbf{Bisección} cuando lo utilizabamos para darle una \textit{semilla} a Newton. Teníamos dos alternativas: iterar una cantidad fija de veces, o acercarnos al valor a una distancia d.
