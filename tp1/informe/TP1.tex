...
Siendo $\epsilon$ una tolerancia previamente establecida (por ejemplo $\epsilon = 10^{-3}$), el criterio que decidimos utilizar es examinar sí \begin{equation}\vert{b_n - a_n}\vert < \epsilon\end{equation}
